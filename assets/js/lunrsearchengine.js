...
function lunr_search(term) {
    ...
    if(term) {
        ...
        if(results.length>0){
            ...
            document.querySelectorAll('#lunrsearchresults ul')[0].innerHTML = "<li class='lunrsearchresult'>Herhangi bir sonuç bulunamadı!</li>";
        }
    }
    return false;
}
